package com.example.housework.util.VSM;

import com.example.housework.mapper.WordMapper;
import com.example.housework.util.Nlpir.NlpirMethod;
...
public class Vsm {
    ...
    public static String path() {
        try{
            ...
            //测试路径
            String filePath=path.getParentFile().getParentFile().getParent()+File.separator+"file";
            return filePath;
