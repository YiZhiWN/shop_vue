...
var _api = __webpack_require__(/*! ../../api.js */ 26);function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) {try {var info = gen[key](arg);var value = info.value;} catch (error) {reject(error);return;}if (info.done) {resolve(value);} else {Promise.resolve(value).then(_next, _throw);}}function _asyncToGenerator(fn) {return function () {var self = this,args = arguments;return new Promise(function (resolve, reject) {var gen = fn.apply(self, args);function _next(value) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value);}function _throw(err) {asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err);}_next(undefined);});};}var leftMessage = function leftMessage() {return __webpack_require__.e(/*! import() | components/left-message */ "components/left-message").then(__webpack_require__.bind(null, /*! ../../components/left-message.vue */ 160));};var rightMessage = function rightMessage() {return __webpack_require__.e(/*! import() | components/right-message */ "components/right-message").then(__webpack_require__.bind(null, /*! ../../components/right-message.vue */ 167));};var _default =
{
  components: {
  ...
  methods: {
    send: function () {var _send = _asyncToGenerator( /*#__PURE__*/_regenerator.default.mark(function _callee() {var data;return _regenerator.default.wrap(function _callee$(_context) {while (1) {switch (_context.prev = _context.next) {case 0:
                ...
                this.messageData.push({ type: -1, message: data.data });
                this.message = "";case 6:case "end":return _context.stop();}}}, _callee, this);}));function send() {return _send.apply(this, arguments);}return send;}() } };exports.default = _default;
